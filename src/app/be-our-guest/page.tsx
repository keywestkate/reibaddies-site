...
export default function BeOurGuestPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="pt-16 bg-[#EC99AF] py-24 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="block italic text-[#53885E]">on the Show?</span>
          </h1>
          <p
      ...
      <section className="py-12 px-6 bg-white">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <p
              className="text-xs uppercase tracking-widest font-semibold text-[#EC99AF] mb-4"
              style={{ fontFamily: "'Lemonilla', sans-serif" }}
            >
            ...
            >
              WE WANT OPERATORS, <span className="text-[#EC99AF]">NOT PROMOTERS</span>
            </h2>

            <ul className="flex flex-col gap-5">
              {requirements.map((req, i) => (
                <li key={i} className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#53885E] border-2 border-[#0D0D0D] flex items-center justify-center shrink-0 mt-0.5">
                    <span className="font-display font-black text-sm" style={{ fontFamily: "'Lucky Goldfish', sans-serif" }}>
                      {i + 1}
                    </span>
                  </div>
                  <p
            ...
            <div className="mt-10 p-6 rounded-2xl bg-[#0D0D0D] text-[#FFFFFF]">
              <p
                className="text-xs uppercase tracking-widest font-semibold text-[#53885E] mb-2"
                style={{ fontFamily: "'Lemonilla', sans-serif" }}
              >
                FYI
              </p>
              <p
                className="text-sm leading-relaxed text-[#FFFFFF]/80"
                style={{ fontFamily: "'Lemonilla', sans-serif" }}
              >
          ...
          <div className="bg-white rounded-3xl border-2 border-[#0D0D0D] p-8">
            ...
            <form className="flex flex-col gap-5">
              ...
              <button
                type="submit"
                className="bg-[#EC99AF] text-white font-semibold px-8 py-4 rounded-full border-2 border-[#0D0D0D] hover:bg-[#0D0D0D] transition-all hover-lift mt-2"
                style={{ fontFamily: "'Lemonilla', sans-serif" }}
              >
